...
def process_demo_batch(process_id, args, env_meta, work_queue, result_queue, progress_queue, gpu_id=None):
    ...
    f = h5py.File(FileUtils.handle_s3(args.dataset), "r")
...
def dataset_states_to_obs_mp(args):
    ...
    with h5py.File(FileUtils.handle_s3(args.dataset), "r") as f:
    ...
    with h5py.File(output_path, "w") as f_out:
        ...
        try:
            for demo in pbar:
                ...
                with h5py.File(FileUtils.handle_s3(temp_file), "r") as f_temp:
