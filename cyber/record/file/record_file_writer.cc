/******************************************************************************
 * Copyright 2018 The World Authors. All Rights Reserved.
 *
...
using world::cyber::proto::Channel;
using world::cyber::proto::ChannelCache;
using world::cyber::proto::ChunkBody;
using world::cyber::proto::ChunkBodyCache;
using world::cyber::proto::ChunkHeader;
using world::cyber::proto::ChunkHeaderCache;
using world::cyber::proto::Header;
using world::cyber::proto::SectionType;
using world::cyber::proto::SingleIndex;
...
bool RecordFileWriter::Open(const std::string& path) {
  ...
  path_ = path;
  if (::world::cyber::common::PathExists(path_)) {
