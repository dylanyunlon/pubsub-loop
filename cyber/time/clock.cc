...
using GlobalData = ::world::cyber::common::GlobalData;

using AtomicRWLock = ::world::cyber::base::AtomicRWLock;
using AtomicWriteLockGuard =
    ::world::cyber::base::WriteLockGuard<AtomicRWLock>;
using AtomicReadLockGuard = ::world::cyber::base::ReadLockGuard<AtomicRWLock>;
  ...
  switch (clock->mode_) {
    ...
    default:
      AFATAL << "Unsupported clock mode: "
             << world::cyber::common::ToInt(clock->mode_);
  }
  return Time::Now();
}
