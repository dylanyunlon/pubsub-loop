...
using ::world::cyber::proto::ClockMode;
using ::world::cyber::proto::CyberConfig;
using ::world::cyber::proto::RunMode;
...
class GlobalData {
 public:
  ...
  world::cyber::proto::ArenaChannelConf GetChannelArenaConf(
