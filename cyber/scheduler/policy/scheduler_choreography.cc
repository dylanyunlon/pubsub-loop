...
using world::cyber::base::AtomicRWLock;
using world::cyber::base::ReadLockGuard;
using world::cyber::base::WriteLockGuard;
using world::cyber::common::GetAbsolutePath;
using world::cyber::common::GetProtoFromFile;
using world::cyber::common::GlobalData;
using world::cyber::common::PathExists;
using world::cyber::common::WorkRoot;
using world::cyber::croutine::RoutineState;
...
SchedulerChoreography::SchedulerChoreography()
  ...
  world::cyber::proto::CyberConfig cfg;
  if (PathExists(cfg_file) && GetProtoFromFile(cfg_file, &cfg)) {
    ...
    const world::cyber::proto::ChoreographyConf& choreography_conf =
