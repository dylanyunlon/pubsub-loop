...
using world::cyber::mainboard::ModuleArgument;
using world::cyber::mainboard::ModuleController;
...
int main(int argc, char** argv) {
  ...
  if (module_args.GetProcessGroup() !=
        world::cyber::mainboard::DEFAULT_process_group_) {
    dag_info = module_args.GetProcessGroup();
  }

  // initialize cyber
  world::cyber::Init(argv[0], dag_info);
