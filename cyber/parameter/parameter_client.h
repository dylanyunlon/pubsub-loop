...
class ParameterClient {
 public:
  using Param = world::cyber::proto::Param;
  using NodeName = world::cyber::proto::NodeName;
  using ParamName = world::cyber::proto::ParamName;
  using BoolResult = world::cyber::proto::BoolResult;
  using Params = world::cyber::proto::Params;
