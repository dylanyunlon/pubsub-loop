...
from omni.isaac.lab_tasks.manager_based.manipulation.mobile_manipulation_obj_scene_v1 import mdp
from omni.isaac.lab_tasks.manager_based.manipulation.mobile_manipulation_obj_scene_v1.mobile_manipulation_obj_scene_env_cfg import MobileManipulationObjSceneEnvCfg
...
class RobotMobileManipulationObjSceneEnvCfg(MobileManipulationObjSceneEnvCfg):
    ...
    def __post_init__(self):
        ...
        camera_lookat_wrist_front = [0.0, 0.0, 0.5]
        camera_pos_wrist_front = [0., 0.1, 0.0]
        camera_up_wrist_front = [0., 1., 0.]

        camera_lookat_wrist_back = [0.0, 0.0, 0.5]
        camera_pos_wrist_back = [0., -0.1, 0.0]
        camera_up_wrist_back = [0., -1., 0.]
        ...
        camera_rot_wrist_front = get_camera_quat(camera_pos_wrist_front, camera_lookat_wrist_front, camera_up_wrist_front)
        camera_rot_wrist_back = get_camera_quat(camera_pos_wrist_back, camera_lookat_wrist_back, camera_up_wrist_back)
        ...
        self.scene.camera_wrist_front = CameraCfg(
            prim_path="{ENV_REGEX_NS}/Robot/arm_right_hand/camera_wrist_front",
            update_period=0.0,
            height=image_resolution,
            width=image_resolution,
            data_types=["rgb", "distance_to_image_plane"],
            ...
            offset=CameraCfg.OffsetCfg(pos=camera_pos_wrist_front, rot=camera_rot_wrist_front, convention="opengl"),
        )

        self.scene.camera_wrist_back = CameraCfg(
            prim_path="{ENV_REGEX_NS}/Robot/arm_right_hand/camera_wrist_back",
            update_period=0.0,
            height=image_resolution,
            width=image_resolution,
            data_types=["rgb", "distance_to_image_plane"],
            ...
            offset=CameraCfg.OffsetCfg(pos=camera_pos_wrist_back, rot=camera_rot_wrist_back, convention="opengl"),
        )
        ...
        self.observations.policy.rgb_wrist_front = ObsTerm(
            func=mdp.image_rgb,
            params={"camera_name": "camera_wrist_front"},
        )

        self.observations.policy.depth_wrist_front = ObsTerm(
            func=mdp.image_depth,
            params={"camera_name": "camera_wrist_front", "depth_max": 1.0},
        )

        self.observations.policy.rgb_wrist_back = ObsTerm(
            func=mdp.image_rgb,
            params={"camera_name": "camera_wrist_back"},
        )

        self.observations.policy.depth_wrist_back = ObsTerm(
            func=mdp.image_depth,
            params={"camera_name": "camera_wrist_back", "depth_max": 1.0},
        )
