...
from omni.isaac.lab_tasks.manager_based.manipulation.mobile_manipulation_obj_scene_v3 import mdp
from omni.isaac.lab_tasks.manager_based.manipulation.mobile_manipulation_obj_scene_v3.mobile_manipulation_obj_scene_env_cfg import MobileManipulationObjSceneEnvCfg
...
class RobotMobileManipulationObjSceneEnvCfg(MobileManipulationObjSceneEnvCfg):
    ...
    def __post_init__(self):
        ...
        for usd_file_name in os.listdir(usd_collection_dir):
            if not usd_file_name.endswith(".usdz") or (usd_file_name.startswith("floor_") and "ceiling" in usd_file_name):
                continue
            
            if "wall_room_2adee539_south_002e044e" in usd_file_name:
                continue
