    ...
    def flush(self, env_ids: Iterable[int] = (0,)):
        ...
        for index in env_ids:
            ...
            for key, value in env_dataset.items():
                ...
                if isinstance(value, dict):
                    ...
                    for sub_key, sub_value in value.items():
                        # print(f"sub_key: {sub_key}; sub_value: {len(sub_value)}; sub_value[0]: {sub_value[0].shape}")
            ...
            if self._demo_count % self._flush_freq == 0:
                ...
                print(f">>> Flushing data to disk. Samples of episode: {len(env_dataset['actions'])}; Collected demos: {self._demo_count} / {self._num_demos}")
