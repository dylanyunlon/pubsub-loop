...
def generate_physics_statistics(traced_data_all, track_ids, collision_record=None):
    """
...
if __name__ == "__main__":
    ...
    physics_statistics = generate_physics_statistics(traced_data_all, eval_physics.track_ids, None)
