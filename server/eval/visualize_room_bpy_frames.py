...
def get_full_view_camera_sampling(room_center, room_scales, resolution, horizontal_angle, vertical_angle, fov=60.0):
    """
    ...
    test_angles = np.array([0, 90, 180, 270]) * np.pi / 180  # Test 4 cardinal angles
