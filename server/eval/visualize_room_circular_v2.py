...
def render_room_circular_video(layout: FloorPlan, room_id: str, output_path: str, 
    ...
    scene.cycles.samples = 4  # Higher samples for smoother, softer lighting
...
if __name__ == "__main__":
    ...
    parser.add_argument("--resolution", type=int, default=1080, help="Video width resolution (default: 1920 for 16:9)")
    parser.add_argument("--angle-step", type=int, default=3, help="Degrees between frames (default: 45, unused)")
    ...
    try:
        ...
        output_path = os.path.join(args.output_dir, f"{args.layout_id}.mp4")
        
        # Render video
        print(f"Rendering circular cam sampling views for room {args.room_id}...")
