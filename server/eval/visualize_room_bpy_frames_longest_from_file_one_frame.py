...
def render_room_circular_video(layout: FloorPlan, room_id: str, layout_dir: str, 
                                resolution=512):
    """
    ...
    frames_dir = os.path.join(output_dir, f"preview")
    ...
    for frame_idx in tqdm(range(num_frames), desc="Rendering frames", unit="frame"):
        ...
        frame_path = os.path.join(frames_dir, f"preview_{frame_idx}.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("layout_json_path", type=str, help="Layout JSON path")
    ...
    try:
        ...
        layout_dir = os.path.dirname(args.layout_json_path)
        layout_name = os.path.splitext(os.path.basename(args.layout_json_path))[0]
        json_path = args.layout_json_path
