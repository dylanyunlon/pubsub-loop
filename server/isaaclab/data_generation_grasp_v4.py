...
parser.add_argument("--num_demos", type=int, default=2, help="Number of episodes to store in the dataset.")
...
def main():
    ...
    log_dir = os.path.abspath(os.path.join("./logs/robomimic", args_cli.task+"-100-v1"))
    ...
    place_location[2] = place_location[2] + grasp_object_height
    ...
    with contextlib.suppress(KeyboardInterrupt):
        while not collector_interface.is_stopped():
            ...
            if not is_reach_grasp_up_goal:
                ...
                is_lift_up = target_object_current_z - target_object_initial_z > expected_success_height
                ...
                if is_lift_up:
                    ...
                    motion_planner.attach_obstacle(
                        f"/World/envs/env_0/{target_object_name}/{target_object_name}",
                        robot_qpos
                    )
                    ...
                    motion_planner.detach_obstacle()
