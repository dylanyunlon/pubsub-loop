...
def main():
    ...
    log_dir = os.path.abspath(os.path.join("./logs/robomimic", args_cli.task+"-20-v2"))
    robomimic_policy_path = os.path.join(ROBOMIMIC_ROOT_DIR, "robomimic/../bc_trained_models/test/20250730200819/models/model_epoch_390.pth")
