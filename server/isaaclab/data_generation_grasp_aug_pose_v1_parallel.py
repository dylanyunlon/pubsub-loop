...
def main():
    ...
    log_dir = os.path.abspath(os.path.join("./logs/robomimic", args_cli.task+"-aug-pose-v2-reach-parallel-16x8-train-set-1"))
    ...
    aug_name = "aug_pose_v2_reach_parallel_s20"
    ...
    layout_aug_ids = sorted(list(object_transform_layouts_dict.keys()))[:2]
