...
parser.add_argument("--task", type=str, default="Isaac-Lift-Single-Obj-Scene-Franka-IK-Abs-v0-vis-teaser", help="Name of the task.")
...
def main():
    ...
    target_object_name = "room_2adee539_coke_54675f09"
    place_object_name = "room_2adee539_alarmclock_847ee577"
    table_object_name = "room_2adee539_dresser_fff38e04"
    num_envs = 1
